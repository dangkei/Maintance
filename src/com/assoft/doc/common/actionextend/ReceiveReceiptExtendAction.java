...
public interface ReceiveReceiptExtendAction {
	...
	public ActionResultInfo<AschemaReceiveReceipt> saveNewReceiveReceipt(AschemaReceiveReceipt entity,Map<String, List<AssoftFileObj>> eleFileMap, AsopUser asopUser, String ip);
