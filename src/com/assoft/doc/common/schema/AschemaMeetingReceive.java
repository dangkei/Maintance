...
//会议接收
public class AschemaMeetingReceive extends AsopSchemaDomain{
  private static final long serialVersionUID = 1L;
  
      private String docTitle;//标题  
      private String docSendId;//制发会议通知id  
      private String meetingDate;//会议时间  
      private String meetingPlace;//会议地点  
      private List<String> joinLeaders;//参会领导  
      ...
      private List<String> joinUnits;//参会单位  
      ...
      public List<String> getJoinLeaders(){
    	return joinLeaders;
      }
      public void setJoinLeaders(List<String> joinLeaders){
