...
//简报接收
public class AschemaBriefingReceive extends AsopSchemaDomain{
  private static final long serialVersionUID = 1L;
      ...
      private List<String> transmitUser;//传阅人  
      private List<String> transmitUserName;//传阅人  名称
      ...
      public List<String> getTransmitUser(){
    	return transmitUser;
      }
      public void setTransmitUser(List<String> transmitUser){
    	this.transmitUser=transmitUser;
	   }
      public List<String> getTransmitUserName(){
    	return transmitUserName;
      }
      public void setTransmitUserName(List<String> transmitUserName){
  ...
  public  void fitElements2Map(Map<String, Object> map){
            ...
            map.put("transmitUser",getTransmitUser());
            map.put("transmitUserName",getTransmitUserName());
